...
var Navigation = /** @class */ (function () {
    function Navigation(layout, container) {
        var self = this;
        self._layout = layout;
        ...
        this._layout.Controls.addEventListener("change", function (e) {
            self.Update();
            self._layout.Renderer.render(self._layout.Scene, self._layout.Camera);
        });
    ...
    Navigation.prototype.MouseDown = function (evt) {
        var self = this;
        self._isDraging = false;
        self._startDragPos = null;
        self._isLeftMouserPressed = (evt.which == 1);
    };
    Navigation.prototype.MouseUp = function (evt) {
        var self = this;
        if (!self._isDraging) {
            var x = evt.clientX;
            var y = evt.clientY;
    ...
    Navigation.prototype.MouseMove = function (evt) {
        var self = this;
        var x = evt.clientX;
        var y = evt.clientY;
        var mouseScreenPos = new THREE.Vector2(x, y);
        ...
        // Update higlight
        //
        var mats = this._cubeHiglight.material.materials;
    ...
    Navigation.prototype.GotoSide = function (side) {
    ...
    Navigation.prototype.GetNavigateSide = function (mousePos) {
    ...
    Navigation.prototype.GetBoxZone = function () {
        var layout = this._layout;
        var canvasSize = layout.GetSize();
        var aspect = canvasSize.x / canvasSize.y;
        var h = 70;
        var w = h * aspect;
        return new THREE.Box2(new THREE.Vector2(canvasSize.x - w - 10, canvasSize.y - h - 10), new THREE.Vector2(canvasSize.x - 10, canvasSize.y - 10));
    };
    Navigation.prototype.CreateArrows = function () {
    ...
    Navigation.prototype.CreateCube = function () {
        var cubeSize = 8;
...
var NavigateBoxSide;
(function (NavigateBoxSide) {
    NavigateBoxSide[NavigateBoxSide["None"] = 0] = "None";
    NavigateBoxSide[NavigateBoxSide["Front"] = 1] = "Front";
    NavigateBoxSide[NavigateBoxSide["Back"] = 2] = "Back";
    NavigateBoxSide[NavigateBoxSide["Right"] = 3] = "Right";
    NavigateBoxSide[NavigateBoxSide["Left"] = 4] = "Left";
    NavigateBoxSide[NavigateBoxSide["Top"] = 5] = "Top";
    NavigateBoxSide[NavigateBoxSide["Bottom"] = 6] = "Bottom";
})(NavigateBoxSide || (NavigateBoxSide = {}));
